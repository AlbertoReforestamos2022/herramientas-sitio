(()=> {
    ...
    class Iniciativa {
        ...
        mostrarInformacion() {
            const item = document.querySelector(`${this.itemTarget}`);
            item.setAttribute('href', `${this.itemLink}`);
...
`;
    ...
    // Centinelas
    const itemCentinelas = document.querySelector('.menu-item-768');
